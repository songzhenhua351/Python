    ...
    def run(self):
        while True:
            ...
            if self.result_queue.full():
                res = sorted([self.result_queue.get() for i in range(self.result_queue.qsize())], key=lambda s: s[1], reverse=True)
...
if __name__ == '__main__':
    ...
    parser.add_option('-s', '--sleep-time', dest='sleep_time', default=10, type="int",
